...
class LocalLLMAnalyzer:
    ...
    def _analysis_worker(self):
        ...
        while self.running:
            try:
                # Get analysis request with timeout
                ...
                # Put result in result queue (keep only latest)
                try:
    ...
    def _create_scene_description(self, detections: List[Dict], frame_info: Dict) -> str:
        ...
        # Describe regular objects (top 5 by confidence)
        if regular_objects:
    ...
    def _parse_llm_response(self, response: str, detections: List[Dict]) -> SceneAnalysis:
        ...
        try:
            ...
            if start_idx >= 0 and end_idx > start_idx:
                ...
                # Fallback: try to parse non-JSON response
